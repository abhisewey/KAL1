  ...
  return (
    <div className="container">
      ...
      <header className="header">
        ...
        <nav className="nav">
          <a className="nav-link" onClick={() => navigate("/login")} href="#">
            <span className="icon"onClick={() => navigate("/login")}>🏃</span> Play
          </a>
          <a className="nav-link" onClick={() => navigate("/login")} href="#">
            <span className="icon" onClick={() => navigate("/login")}>🏐</span> Book
          </a>
        </nav>

        <button className="auth-btn" onClick={() => setShowLogin(true)}>
          <span className="icon">👤</span> Login / Signup
        </button>
      </header>
      ...
      <main className="main-content">
        ...
        <div className="content-left">
          ...
          <p className="subheadline">
            Kerala's Largest Football Community to Book
            <br />
